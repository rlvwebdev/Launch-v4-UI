...
export const liquidNavigation = [
  {
    ...
    title: 'Dashboard',
    items: [
      { id: 'overview', label: 'Overview', path: '/liquid/overview', icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg>' },
    ],
  },
  {
    id: 'terminal',
    ...
    items: [
      ...
      { id: 'building', label: 'Building', path: '/liquid/terminal/building', icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="4" y="2" width="16" height="20" rx="2"/><path d="M9 22v-4h6v4M8 6h.01M16 6h.01M12 6h.01M12 10h.01M12 14h.01M16 10h.01M16 14h.01M8 10h.01M8 14h.01"/></svg>' },
    ],
  },
  {
    id: 'fleet',
